...
# Ev refers to "Effort Value", You gain EVs by defeating enemies, if PokemonA defeats pokemonB then pokemonA will get pokemonB's xp yield value and ev yield value
@export var ev_yield: Dictionary = {
	ALIAS.HP: 0, ALIAS.ATK: 0, ALIAS.DEF: 0,
	ALIAS.SPATK: 0, ALIAS.SPDEF: 0, ALIAS.SPD: 0
}

@export var xp_yield: int = 40 # Base XP reward the opposite gains by defeating this pokemon
